...
```
nikhilh@ubuntu:~/overthewire/krypton/level5$ ssh -p 2222 krypton5@krypton.labs.overthewire.org 
 _                     _              
...
Using the Vijenere cipher decoder on the website, `www.mygeocachingprofile.com/codebreaker.vigenerecipher.aspx` on text contents of `found1`, the key was found to be `keylengthkeylengthkeylengthkeyltngthxeylengthktyyengthktyaengthxemlenggh`. Using this key on the contents of `krypton6`, yielded `RANDOM`.
